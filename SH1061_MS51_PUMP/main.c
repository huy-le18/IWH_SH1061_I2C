...
#define CYCLE_FOR_ELCB								17
#define CYCLE_FOR_RESET_ELCB					20
#define FLAG_WRITE					0
#define FLAG_READ						1
...
{
//   23	  28   33   38   43
	{309, 325 ,373, 390, 406},   // 16
	{294, 303 ,370, 387, 404},   // 18
	{280, 297 ,368, 385, 403},   // 20
	{265, 293 ,348, 385, 403},   // 22
	{233, 291 ,329, 368, 407},   // 24
	{228, 269 ,311, 352, 414},   // 26
	{203, 270 ,293, 338, 383},   // 28
	{175, 225 ,250, 325, 360},   // 30
	{170, 230 ,240, 270, 350},   // 32
	{160, 220 ,230, 250, 330},   // 34
	{150, 200 ,210, 230, 270},   // 36
	{130, 170 ,190, 230, 230},   // 38
	{110, 140 ,170, 200, 230},   // 40
	{90 , 120 ,150, 180, 210}    // 42
};
          ...
          reset_lo_write_low();
			...
			if(b_flag_i2c_receive == 1)
			{
				if(m_rx_data[2] == CRC8(m_rx_data, 2))
				{
					...
					else if(data_handle[0] & (1 << CMD_RESET_BIT))
					{
